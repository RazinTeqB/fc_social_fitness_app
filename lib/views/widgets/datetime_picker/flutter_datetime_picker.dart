...
import 'dart:async';
import 'package:fc_social_fitness/views/widgets/datetime_picker/src/date_model.dart';
import 'package:fc_social_fitness/views/widgets/datetime_picker/src/datetime_picker_theme.dart';
import 'package:fc_social_fitness/views/widgets/datetime_picker/src/i18n_model.dart';
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? DatePickerThemeCustom(),
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    DatePickerThemeCustom theme = widget.route.theme;
  ...
  Widget _renderPickerView(DatePickerThemeCustom theme) {
  ...
  Widget _renderItemView(DatePickerThemeCustom theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DatePickerThemeCustom theme) {
