import 'package:fc_social_fitness/constants/path_constants.dart';
import 'package:fc_social_fitness/constants/text_constants.dart';

import '../views/widgets/onboarding_tile.widget.dart';

class DataConstants {
  // Onboarding
  static final List<OnboardingTile> onboardingTiles = [
    OnboardingTile(
