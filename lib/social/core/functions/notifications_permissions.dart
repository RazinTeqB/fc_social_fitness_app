...
Future<void> _handleMessage(BuildContext context, RemoteMessage message) async {
  await _pushToPage(context,
      ...
      isThatGroupChat: message.data["isThatGroupChat"]!=null? message.data["isThatGroupChat"] as bool: false);
}
...
AndroidNotificationDetails _videoCallAndroidNotificationDetails(
  ...
  return AndroidNotificationDetails(
    ...
    sound: isThatCalling
        ? const RawResourceAndroidNotificationSound('@raw/video')
        : const RawResourceAndroidNotificationSound('@raw/notification'),
  );
}
...
Future<void> _loadFCM(BuildContext context) async {
  ...
  const InitializationSettings initializationSettings = InitializationSettings(
      android: AndroidInitializationSettings("launch_background"),iOS: IOSInitializationSettings());
