...
import '../screeshot/screenshot.dart';
    ...
    return [
      ...
      if (widget.allowGallery)
        IconButton(
          ...
          icon: const Icon(Icons.photo),
          onPressed: () async {
            var image = await picker.pickImage(imageQuality: 100, source: ImageSource.gallery);
      ...
      if (widget.allowCamera)
        IconButton(
          ...
          icon: const Icon(Icons.camera_alt),
          onPressed: () async {
            var image = await picker.pickImage(imageQuality: 100, source: ImageSource.camera);
          ...
          child: SafeArea(
            child: ListView(
              ...
              children: <Widget>[
                BottomButton(
                  icon: Icons.crop,
                  text: "${FFLocalizations.of(context).getText('Crop')}",
                  onTap: () async {
                    resetTransformation();
                ...
                BottomButton(
                  ...
                  text: "${FFLocalizations.of(context).getText('Text')}",
                  onTap: () async {
                ...
                BottomButton(
                  icon: Icons.flip,
                  text: "${FFLocalizations.of(context).getText('Flip')}",
                  onTap: () {
                    setState(() {
                ...
                BottomButton(
                  ...
                  text: "${FFLocalizations.of(context).getText('Rotate left')}",
                  onTap: () {
                ...
                BottomButton(
                  ...
                  text: "${FFLocalizations.of(context).getText('Rotate right')}",
                  onTap: () {
                    var t = currentImage.width;
                    currentImage.width = currentImage.height;
                    currentImage.height = t;
                ...
                BottomButton(
                  icon: Icons.blur_on,
                  text: "${FFLocalizations.of(context).getText('Blur')}",
                  onTap: () {
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      "${FFLocalizations.of(context).getText('Blur radius')}",
                                      style:
                                          const TextStyle(color: Colors.white),
                                    ),
                                    ...
                                    const SizedBox(height: 5.0),
                                    Text(
                                      "${FFLocalizations.of(context).getText('Color opacity')}",
                                      style:
                                          const TextStyle(color: Colors.white),
                                    ),
                                    const SizedBox(height: 10.0),
                ...
                BottomButton(
                  icon: Icons.photo,
                  text: "${FFLocalizations.of(context).getText('Filter')}",
                  onTap: () async {
                    resetTransformation();
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      ...
                      imageRatioButton(null, "${FFLocalizations.of(context).getText('Freeform')}"),
                      imageRatioButton(1, "${FFLocalizations.of(context).getText('Square')}"),
